...
class MasterProgramController extends Controller
{
    ...
    public function storeKegiatan(Request $request)
    {
        ...
        $request->validate([
            ...
            'kode_kegiatan' => 'required|unique:activities,kode_kegiatan',
    ...
    {
        $request->validate([
            'kode_kegiatan' => 'required|unique:activities,kode_kegiatan,'.$id,
            'nama_kegiatan' => 'required'
        ]);
    ...
    // dd($request->all());
        $request->validate([
            'kode_sub_kegiatan' => 'required|unique:sub_activities,kode_sub_kegiatan',
