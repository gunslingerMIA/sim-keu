                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="account_id" class="form-select" id="select-account" required>
                                        ...
                                        @foreach ($accounts as $acc)
                                            <option value="{{ $acc->id }}">{{ $acc->kode_rekening }} -
                                                {{ $acc->nama_rekening }}</option>
                                        @endforeach
                                    </select>
                                </div>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table table-hover" id="table">
                                <thead>
                                    <tr>
                                        <th>Kode Rekening</th>
                                        <th>Uraian</th>
                                ...
                                <tfoot class="bg-light">
                                    <tr>
                                        <td colspan="2" class="text-end h4 fw-bold text-uppercase">Total Pagu Sub
                                            Kegiatan:</td>
                                        <td class="text-end h4 text-azure fw-bold">Rp
